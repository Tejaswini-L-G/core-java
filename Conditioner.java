...
public Conditioner(int productId,String brand,String variant,String hairType,String color,double price,int volumeMl,String ingredient,String fragrance,String manufacturer,String originCountry,String usageType,String quality,String packaging,String shelfLife,String availability,String supplier,String description,String category,int rating){
...
System.out.println("The conditioner id is "+this.productId);
...
System.out.println("The volume is "+this.volumeMl);
